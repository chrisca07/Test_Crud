    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="barang"><i class="fa fa-circle-o"></i> Input</a></li>
            <li data-toggle="modal" data-target="#modal-default" class="active"><a href="tampil"><i class="fa fa-circle-o"></i> Tampil Data</a></li>
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-md-10">
                        <h3>Form Input</h3>
                        <form class="form-horizontal" action="/lte/save" method="post">
